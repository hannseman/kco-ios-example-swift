...
@protocol KCOCheckoutSizingDelegate
, KCOCheckoutDelegate;
 ...
 * If you are embeddning the view in a scrollView you should also disable
 * internal scroll,
...
/**
 * Returns the current height of the checkout. Use this to set an initial value
 * for the height
